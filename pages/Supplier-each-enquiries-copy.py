...
materials= pd.read_csv(r"/Users/anishmnair/Desktop/Streamlit/My_new_app/BMTS-APP/Service/MATERIALS LIST.csv")

team_list= pd.read_csv(r"/Users/anishmnair/Desktop/Streamlit/My_new_app/BMTS-APP/Service/Team_list.csv")
...
if st.session_state['authentication_status']:
	...
	our_all_data= st.session_state['keys201']
...
if authentication_status() == True:
    ...
    our_data= our_all_data[our_all_data['Company'] == name]
...
with container:
	...
	with col2:
		...
		text9 = st.text_area('Clarification on Enquiry:', placeholder= 'Please type here')
		if st.button('submit'):
			our_data['Clarification'] = text9
